package com.fontys.s3.buyahouse.configuration.security.isauthenticated;
...
public class IsAuthenticatedAspect {
    ...
    @Pointcut("@annotation(com.fontys.s3.buyahouse.configuration.security.isauthenticated.IsAuthenticated)")
    public void annotatedMethod() {
    }

    @Pointcut("@within(com.fontys.s3.buyahouse.configuration.security.isauthenticated.IsAuthenticated)")
